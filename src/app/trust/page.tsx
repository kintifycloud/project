...
export default function TrustPage() {
  const jsonLd = {
    ...
    description:
      "A continuous trust layer above cloud systems that proves integrity and system correctness.",
    serviceType: "Cloud Trust Layer",
    provider: {
      "@type": "Organization",
      name: "Kintify",
    },
  ...
  return (
    <>
        ...
        <div className="mx-auto flex h-12 w-full max-w-5xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-4">
            <nav className="flex items-center gap-3 text-sm text-zinc-400">
              ...
              <Link className="text-white" href="/trust">
                Trust
              </Link>
      ...
      <footer className="border-t border-zinc-800/60 px-4 py-6 text-center">
        <p className="font-mono text-xs text-zinc-600">Built for unified trust</p>
      </footer>
      </main>
    </>
  );
