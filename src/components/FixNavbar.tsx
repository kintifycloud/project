      ...
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex md:items-center md:gap-4">
          ...
          <Link
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            href={"/history" as any}
            className="px-3 py-1.5 rounded-md text-sm font-medium text-zinc-400 transition-colors hover:text-white hover:bg-zinc-800/50"
          >
            History
          </Link>
        </div>
        ...
        <div className="md:hidden border-t border-zinc-800/60 bg-zinc-950/95 backdrop-blur-md">
          <nav className="flex flex-col px-4 py-4 gap-2">
            ...
            <Link
              // eslint-disable-next-line @typescript-eslint/no-explicit-any
              href={"/history" as any}
              className="px-3 py-2 rounded-md text-sm text-zinc-400 transition-colors hover:text-white hover:bg-zinc-800/50"
              onClick={() => setMobileMenuOpen(false)}
            >
              History
            </Link>
